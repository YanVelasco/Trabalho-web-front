...
BEGIN
  ...
  VALUES 
  ('Java', 'Aprenda Java, uma linguagem de programação versátil e amplamente utilizada. Ideal para construir aplicações robustas, seguras e portáteis.', GETDATE(), 30),
  ...
  ('CSS', 'Pratique CSS, uma linguagem de folha de estilo usada para descrever a aparência e a formatação de um documento escrito em HTML.', GETDATE(), 12),
  ('PHP', 'Mergulhe no PHP, uma linguagem de script do lado do servidor popular projetada para desenvolvimento web, mas também usada como linguagem de programação de propósito geral.', GETDATE(), 15),
  ('JavaScript', 'Explore o JavaScript, uma linguagem de programação de alto nível e interpretada que é uma tecnologia central da World Wide Web.', GETDATE(), 100),
  ('MySQL', 'Aprenda MySQL, um sistema de gerenciamento de banco de dados que usa SQL como interface. É um dos bancos de dados mais populares do mundo.', GETDATE(), 5),
  ...
  ('Git', 'Aprenda Git, um sistema de controle de versão distribuído que permite rastrear mudanças no código fonte durante o desenvolvimento de software.', GETDATE(), 1),
  ('GitHub', 'Explore o GitHub, uma plataforma de hospedagem de código-fonte com controle de versão usando o Git. É onde mais de 65 milhões de desenvolvedores moldam o futuro do software, juntos.', GETDATE(), 1),
  ('Visual Studio Code', 'Domine o Visual Studio Code, um editor de código-fonte desenvolvido pela Microsoft para Windows, Linux e macOS. Ele inclui suporte para depuração, controle Git incorporado, realce de sintaxe, complementação inteligente de código, snippets e refatoração de código.', GETDATE(), 1),
